    ...
    public class HouseEntityConfiguration : IEntityTypeConfiguration<House>
    {
        ...
        private House[] GenerateHouses()
        {
            ...
            house = new House()
            {
                ...
                CategoryId = 3,
                AgentId = Guid.Parse("6DD681B2-3BDA-4B30-9755-0E12C7F27CE4"), //AgentId
                RenterId = Guid.Parse("C7B6E1A6-954B-47E6-8CF7-A488A810CE96") //UserId
            };
            houses.Add(house);
            ...
            house = new House()
            {
                ...
                CategoryId = 2,
                AgentId = Guid.Parse("6DD681B2-3BDA-4B30-9755-0E12C7F27CE4"),
            };
            houses.Add(house);
